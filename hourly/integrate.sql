/*
# vi: tw=100
# $Id: integrate.sql,v 1.28.2.19 2003/04/27 17:20:55 decibel Exp $
#
...
select p.PROJECT_ID,  min(TIME_STAMP) as STATS_DATE, coalesce(sum(WORK_UNITS),0) * min(WORK_UNIT_IMPORT_MULTIPLIER) as TOTAL_WORK,
        count(*) as TOTAL_ROWS
