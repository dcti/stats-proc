...
/*
#
# $Id: em_rank.sql,v 1.13 2002/03/28 00:35:26 bwilson Exp $
#
...
update #rank_today
	set RANK = (select min(IDENT) from #rank_today rat2 where rat2.WORK_TODAY = #rank_today.WORK_TODAY)
	where 1 = 1
...
update #rank_overall
	set RANK = (select min(IDENT) from #rank_overall rao2 where rao2.WORK_OVERALL = #rank_overall.WORK_OVERALL)
	where 1 = 1
